/**
 * Outlook Web Signature Template (Marketing-Frozen Layout)
 * -------------------------------------------------------
...
export function buildOutlookSignatureNew({
  ...
  mobile,
  logoBase64,
  formatPhoneNumber = (x) => x, // fallback safety
}) {
...
">
    <tr>
        <td>
            <!-- MAIN SIGNATURE CARD (marketing-frozen zone) -->
            <table role="presentation" cellpadding="0" cellspacing="0" width="487" style="
                font-family:'Montserrat', Arial, Helvetica, sans-serif; /* freeze */
                background:#ffffff !important;
                border-radius:12px;
                padding:12px;
                color: #000 !important;
