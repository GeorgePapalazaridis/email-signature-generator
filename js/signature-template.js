      ...
      <td>
                  ...
                  <td style="background:#F8F8F8; border-radius:12px; padding:22px 14px;">
                      <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                              ...
                              <!-- Divider -->
                              <td valign="middle"
                                  style="width:1px; background:#b3b2b2; font-size: 7px; line-height:0;">&nbsp;</td>
              ...
              <tr>
                  <td align="center" style="text-align:center;">
                      <table role="presentation" width="484px" cellpadding="0" cellspacing="0">
                          <tr>
                              <td style="border-top:1px solid #646464; height:10px; line-height:10px; font-size:0; mso-line-height-rule:exactly;">
                                  &nbsp;
                              </td>
                          </tr>
                      </table>
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
              ...
              <tr>
                  ...
                  <!-- Phone -->
                  <td
                      style="font-family: Monserrat, Arial, Helvetica, sans-serif; font-size:13px; color:#000; white-space:nowrap; padding-right:14px; vertical-align:middle;">
                      <img src="https://www.prognosis-biotech.com/apps/icons/20251008/call.png" alt="Phone" width="13"
                          height="14"
                          style="display:inline-block; vertical-align:middle; margin-right:6px; border:0;">
                      <a href="tel:${phone}"
                          style="font-family: Monserrat, Arial, Helvetica, sans-serif; font-size:13px; font-weight:500; color:#000; text-decoration:none; display:inline-block; vertical-align:middle;">
                          ${phone}
                      </a>
                  </td>
                  ...
                  <!-- Website -->
                  <td style="font-family: Monserrat, Arial, Helvetica, sans-serif;
              font-size:13px; color:#000; white-space:nowrap;
              padding-right:14px; vertical-align:middle;">
                      <img src="https://www.prognosis-biotech.com/apps/icons/20251008/language.png" alt="Website"
                          width="14" height="14" style="display:inline-block;
                vertical-align:-1.5px;
                margin-right:6px;
                border:0;">
                      <a href="https://www.prognosis-biotech.com" target="_blank" style="font-family: Monserrat, Arial, Helvetica, sans-serif;
                  font-size:13px;
                  font-weight:600;
                  color:#000;
              ...
              <tr>
                  ...
                  <td colspan="2"
                      ...
                      <img src="https://www.prognosis-biotech.com/apps/icons/20251008/factory.png" alt="Address"
                          width="15" height="15"
                          style="display:inline-block; vertical-align:middle; margin-right:6px; border:0;">
                  ...
                  <td
                      ...
                      <a href="https://www.linkedin.com/company/prognosisbiotech" target="_blank"
                          ...
                          <img src="https://www.prognosis-biotech.com/apps/icons/20251008/linkedIn.png" alt="LinkedIn"
                      ...
                      <a href="https://www.youtube.com/@prognosisbiotech" target="_blank"
                          style="display:inline-block; vertical-align:middle; margin-left:14px; text-decoration:none;">
                          <img src="https://www.prognosis-biotech.com/apps/icons/20251008/youtube.png" alt="YouTube"
                              width="20" height="20" style="display:block; border:0;">
                      </a>
                      ...
                      <a href="https://www.facebook.com/prognosisbiotechGR/?locale=el_GR" target="_blank"
                          style="display:inline-block; vertical-align:middle; margin-left:14px; text-decoration:none;">
                          <img src="https://www.prognosis-biotech.com/apps/icons/20251008/facebook.png" alt="Facebook"
                              width="20" height="20" style="display:block; border:0;">
                      </a>
                      ...
                      <a href="https://www.instagram.com/prognosisbiotech/" target="_blank"
                          style="display:inline-block; vertical-align:middle; margin-left:14px; text-decoration:none;">
                          <img src="https://www.prognosis-biotech.com/apps/icons/20251008/instagram.png"
          ...
          <table role="presentation" width="484px" cellpadding="0" cellspacing="0">
              <tr>
                ...
                word-break:break-word;">
                      ...
                      <span style="font-weight:600;">DISCLAIMER: This email is intended solely for the recipient(s)
                          and may
                          contain confidential information.
                          By reading this email, you agree to treat its contents as confidential. For our full email
                          disclaimer,
                          please visit:
