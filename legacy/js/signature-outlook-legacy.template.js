export function buildOutlookSignatureLegacy({
  name,
  title,
  address,
  phone,
    ...
    <tr>
        ...
        ">
              ...
              ">
                        ...
                        <table width="100%" role="presentation" style="table-layout: fixed">
                            <tr>
                                ...
                                <td width="50%" align="center">
                                    <img src="${logoBase64}" alt="ProGnosis Biotech" style="
                      display: block;
                      width: 200px;
                      max-width: 200px;
                      height: auto;
                ...
                <tr>
                  ...
                  ">
                                    ...
                                    <a href="https://www.prognosis-biotech.com" target="_blank" style="
                      color: #000 !important;
                      font-weight: 600;
                      text-decoration: none;
                    ">
            ...
            ">
                        ...
                        visit:
                        <a href="https://www.prognosis-biotech.com/disclaimer" style="
